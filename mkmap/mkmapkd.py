...
toc()
tic()
print 'testing Invdisttree'
tree = Invdisttree(np.r_['1,2,0',x1.flatten(),y1.flatten()], z1.flatten())
toc()
tic()
print 'testing tree'
z2 = tree(np.r_['1,2,0',x2.flatten(),y2.flatten()],p=1,nnear=4)
toc()
tic()
if Plot:
